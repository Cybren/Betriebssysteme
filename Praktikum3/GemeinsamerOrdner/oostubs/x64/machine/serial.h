...
public:
	...
	/*! \brief Unterbrechung bei Datenempfang
	 *
	 * Aktiviert oder deaktiviert den Interrupt bei Datenempfang.
	 * Dazu wird neben dem entsprechenden Register auch der IOAPIC
	 * (unter Berücksichtigung des jeweiligen COM-Ports) konfiguriert
	 * sowie der Empfangspuffer geleert.
	 *
	 *  \param enable Soll die Unterbrechung aktiviert werden?
	 *  \return `true` falls die Unterbrechung zuvor aktiviert war,
	 *          ansonst `false`
	 */
