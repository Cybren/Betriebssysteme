...
namespace Multiboot {
	class Module {
		uint32_t start;        // Startaddresse
		uint32_t end;          // Endaddresse (exklusive)
		uint32_t cmdline;      // Kommandozeilenparameter
		uint32_t pad UNUSED_STRUCT_FIELD; // Füller, muss 0 sein
	public:
