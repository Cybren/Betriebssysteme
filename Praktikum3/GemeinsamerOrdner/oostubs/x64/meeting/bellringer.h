...
public:
	...
	/*! \brief Verbleibende Zeit bis die Glocke \b bell geläutet wird.
	 *  \param bell Die Glocke, deren verbleibende Zeit abgefragt werden soll.
...
private:
	/*! \brief Die Liste der Glocken die gerade verwaltet wird.
	 *
	 * In dieser Liste sind die Glocken, die von job() eingetragen
	 * wurden und noch nicht abgelaufen sind. Sie werden bei jedem
	 * check() überprüft.
	 *
	 * Als Verkettungszeiger wird das Bell::bellringer_link Feld
	 * verwendet.
	 */
